...
public class PremierLeagueDAO {
	...
	public List<Player> getGiocatori(Match m, Map<Integer, Player> mappa){
		...
		try {
			...
			while (res.next()) {
				Player p = new Player(res.getInt("id"),mappa.get(res.getInt("id")).getName() );
				result.add(p);
	...
	public List<Action> getActionsTeam(Match m){
		String sql = "SELECT a.* "
				+ "FROM actions a  "
				+ "WHERE a.MatchID = ?";
	...
	public int getTeam(Integer playerID) {
